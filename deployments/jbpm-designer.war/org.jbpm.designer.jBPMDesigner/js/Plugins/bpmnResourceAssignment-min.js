...
var j=b[1];
if(m!="--automatic execution--"){var a=new Ext.Window({frame:true,title:"Please choose resources for assignment",width:600,modal:true,closable:false,plain:true,items:{xtype:"checkbox",boxLabel:m.resource[0].resource,name:"checkbox0"},buttons:[{text:"Select",handler:function(){a.close();
g=this.getCheckedValues(a);
this.writeAssignments(g,l,j)
}.bind(this)},{text:"Close",handler:function(){a.close()
}.bind(this)}]});
var e;
var k;
for(var f=1;
...
if(c!="1"&&c!="2"&&c!="3"&&c!="4"&&c!=null){alert("wrong entry, please try again");
