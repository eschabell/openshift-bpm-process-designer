...
var F=new Ext.Window({width:450,height:485,resizable:false,minimizable:false,modal:true,autoScroll:true,title:ORYX.I18N.AdHocCC.editCC,layout:"table",defaults:{bodyStyle:"padding:3px;background-color:transparent;border-width:0px"},layoutConfig:{columns:7},items:[{items:[new Ext.form.Label({text:ORYX.I18N.AdHocCC.addExecState,style:"font-size:12px;"})],colspan:7},{},{items:[N],colspan:6},{},{items:[D],colspan:4},{items:[A]},{},{colspan:7},{items:[new Ext.form.Label({text:ORYX.I18N.AdHocCC.addDataExp,style:"font-size:12px;"})],colspan:7},{},{items:[M],colspan:6},{},{items:[x],colspan:4},{items:[u]},{},{colspan:7},{items:[new Ext.form.Label({text:ORYX.I18N.AdHocCC.addLogOp,style:"font-size:12px;"})],colspan:7},{},{items:[c]},{items:[b]},{items:[B]},{items:[l]},{items:[E]},{},{colspan:7},{items:[new Ext.form.Label({text:ORYX.I18N.AdHocCC.curCond,style:"font-size:12px;"})],colspan:7},{},{items:[a],colspan:5},{},{colspan:5},{items:[r]},{}],buttons:[{text:"Apply",handler:function(){F.hide();
h.properties["oryx-adhoccompletioncondition"]=a.getValue();
this.facade.setSelection([]);
this.facade.setSelection(f)
}.bind(this)},{text:"Cancel",handler:function(){F.hide()
...
},openErroDialog:function(a){Ext.MessageBox.show({title:"Error",msg:a,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})
}});