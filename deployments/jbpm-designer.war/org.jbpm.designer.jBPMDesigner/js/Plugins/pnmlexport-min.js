...
var e="<h2>Process: "+self.document.title+'</h2><a target="_blank" href="'+f;
var h=new Ext.Window({width:320,height:240,resizable:false,minimizable:false,modal:true,autoScroll:true,title:"Deployment successful",html:e,buttons:[{text:"OK",handler:function(){h.hide()
}}]});
h.show()
}}})
