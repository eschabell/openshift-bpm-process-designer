...
Ext.form.ConditionExpressionEditorField=Ext.extend(Ext.form.TriggerField,{onTriggerClick:function(){if(this.disabled){return
...
var R=true;
var n;
var k=new Ext.form.TextArea({id:Ext.id(),fieldLabel:"Expression Editor",value:this.value.replace(/\\n/g,"\n"),autoScroll:true});
var M;
var l;
...
if(ORYX.READONLY!=true){this.facade.offer({name:"Show in full screen",functionality:function(c){var d=parent.document.getElementById(ORYX.EDITORID);
...
}}}}.bind(this),group:"fullscreengroup",icon:ORYX.BASE_FILE_PATH+"images/fullscreen.png",description:"Show in full screen mode",index:2,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:"Share Process Image",functionality:this.shareProcessImage.bind(this),group:"sharegroup",icon:ORYX.BASE_FILE_PATH+"images/share.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/share.png",description:"Share Process Image",index:1,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:"Share Process PDF",functionality:this.shareProcessPdf.bind(this),group:"sharegroup",icon:ORYX.BASE_FILE_PATH+"images/share.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/share.png",description:"Share Process PDF",index:2,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
...
this.facade.offer({name:"Import from JSON",functionality:this.importFromJSON.bind(this),group:"importgroup",icon:ORYX.BASE_FILE_PATH+"images/import.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/import.png",description:"Import from existing JSON",index:2,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:"Download Process PDF",functionality:this.showAsPDF.bind(this),group:"sharegroup",icon:ORYX.BASE_FILE_PATH+"images/share.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/share.png",description:"Download Process PDF",index:4,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:"Download Process PNG",functionality:this.showAsPNG.bind(this),group:"sharegroup",icon:ORYX.BASE_FILE_PATH+"images/share.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/share.png",description:"Downlod Process PNG",index:3,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:"View Process Sources",functionality:this.showProcessSources.bind(this),group:"sharegroup",icon:ORYX.BASE_FILE_PATH+"images/share.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/share.png",description:"View Process Sources",index:5,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)})
...
var g=new Ext.Window({width:400,id:"sharedPDFURL",height:250,autoScroll:true,layout:"fit",title:"Process PDF URL",items:[d]});
g.show()
...
var g=new Ext.Window({width:400,id:"sharedImageURL",height:250,layout:"fit",autoScroll:true,title:"Process Image URL",items:[d]});
g.show()
...
d++
}}if(d==0){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_NOTIFICATION_SHOW,ntype:"error",msg:"Unable to find process versions.",title:"Diff"})
...
var m=new Ext.Button({text:"Download BPMN2",handler:function(){var A=ORYX.EDITOR.getSerializedJSON();
...
var n=new Ext.Window({width:600,id:"processSources",height:550,layout:"fit",title:"Process Sources",items:[g],tbar:[m]});
n.show();
...
}catch(o){ORYX.EDITOR._pluginFacade.raiseEvent({type:ORYX.CONFIG.EVENT_NOTIFICATION_SHOW,ntype:"error",msg:"Converting to BPMN2 failed:"+o,title:""})
}}.createDelegate(this),failure:function(){ORYX.EDITOR._pluginFacade.raiseEvent({type:ORYX.CONFIG.EVENT_NOTIFICATION_SHOW,ntype:"error",msg:"Converting to BPMN2 failed.",title:""})
},params:{action:"toXML",pp:ORYX.PREPROCESSING,profile:ORYX.PROFILE,data:a}})
...
if(ORYX.READONLY!=true){this.facade.offer({name:"Start validating",functionality:this.enableValidation.bind(this),group:"validationandsimulation",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/visualvalidation.png",description:ORYX.I18N.SyntaxChecker.desc,index:1,minShape:0,maxShape:0,isEnabled:function(){return !ORYX.IS_VALIDATING_PROCESS&&ORYX.READONLY!=true
}});
...
this.facade.offer({name:"View all issues",functionality:this.viewAllValidation.bind(this),group:"validationandsimulation",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/visualvalidation.png",description:ORYX.I18N.SyntaxChecker.desc,index:3,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}})
...
this.initDictionary();
if(ORYX.READONLY!=true){this.facade.offer({name:"Dictionary",functionality:this.initAndShowDictionary.bind(this),group:ORYX.I18N.View.jbpmgroup,icon:ORYX.BASE_FILE_PATH+"images/dictionary.png",description:"Process dictionary",index:8,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)})
...
for(var d=0;
d<a.length;
d++){if(ORYX.READONLY!=true){this.facade.offer({name:a[d],functionality:this.applyTheme.bind(this,a[d]),group:"colorpickergroup",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/colorpicker.gif",icon:ORYX.BASE_FILE_PATH+"images/colorize.png",description:"Apply "+a[d]+" Color Theme",index:10,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)})
...
if(ORYX.READONLY!=true){this.facade.offer({name:"Process Paths",functionality:this.findPaths.bind(this),group:"validationandsimulation",icon:ORYX.BASE_FILE_PATH+"images/path.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/simulation.png",description:ORYX.I18N.View.sim.processPaths,index:1,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:"Run Simulation",functionality:this.runSimulation.bind(this),group:"validationandsimulation",icon:ORYX.BASE_FILE_PATH+"images/control_play.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/simulation.png",description:ORYX.I18N.View.sim.runSim,index:2,minShape:0,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)})
...
if(k){b=new Ext.tree.TreeNode({text:ORYX.I18N.View.sim.resultsGroupProcess,allowDrag:false,allowDrop:false,expanded:true,isLeaf:false,singleClickExpand:true});
...
if(m||g){b=new Ext.tree.TreeNode({text:ORYX.I18N.View.sim.resultsGroupProcessElements,allowDrag:false,allowDrop:false,expanded:true,isLeaf:false,singleClickExpand:true});
for(var l=0;
l<m.length;
l++){var o=m[l];
...
if(e){b=new Ext.tree.TreeNode({text:ORYX.I18N.View.sim.resultsGroupProcessPaths,allowDrag:false,allowDrop:false,expanded:true,isLeaf:false,singleClickExpand:true});
for(var l=0;
l<e.length;
l++){var a=e[l];
...
}if(ORYX.READONLY!=true){this.facade.offer({name:"Display Local History",functionality:this.displayLocalHistory.bind(this),group:"localstorage",icon:ORYX.BASE_FILE_PATH+"images/view.png",dropDownGroupIcon:ORYX.BASE_FILE_PATH+"images/localhistory.png",description:"Display Local History",index:1,minShape:0,maxShape:0,isEnabled:function(){return ORYX.LOCAL_HISTORY_ENABLED&&ORYX.READONLY!=true
}.bind(this)});
