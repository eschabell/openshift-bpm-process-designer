...
ORYX.I18N.BPMN2PNConverter={name:"Konvertiere zu Petrinetz",desc:"Konvertiert BPMN-Diagramme in Petrinetze",group:"Export",error:"Fehler",errors:{server:"BPMN Diagramm konnte nicht importiert werden!",noRights:"Es sind keine Leserechte für das importierte Diagramm vorhanden!",notSaved:"Das Diagramm wurde noch nicht gespeichert und/ oder muss neu geöffnet werden!"},progress:{status:"Status",importingModel:"Importiere BPMN Model",fetchingModel:"Lade",convertingModel:"Konvertiere",renderingModel:"Zeige an"}};
...
ORYX.I18N.JSONSupport={imp:{name:"JSON importieren",desc:"Importiert ein neues Modell aus JSON",group:"Export",selectFile:"Wählen Sie eine JSON-Datei (*.json) aus, die Sie importieren möchten, oder fügen Sie JSON in das Textfeld ein.",file:"Datei",btnImp:"Importieren",btnClose:"Schließen",progress:"Importieren ...",syntaxError:"Syntaxfehler"},exp:{name:"Nach JSON exportieren",desc:"Exportiert das aktuelle Modell nach JSON",group:"Export"}};
...
ORYX.I18N.Feedback.info='<p>Oryx ist eine wissenschaftliche Modellierungsplattform, die darauf abzielt, Forschung im Bereich Business Process Management und darüber hinaus zu unterstützen.</p><p><a href="http://bpt.hpi.uni-potsdam.de/Oryx/DeveloperNetwork" target="_blank">Wir</a> sind stolz darauf, Ihnen <a href="http://bpt.hpi.uni-potsdam.de/Oryx/ReleaseNotes" target="_blank">neueste Methoden und Technologien</a> zur Verfügung zu stellen und bemühen uns, die Plattform stets zuverlässig zu betreiben.</p><p>Wenn Sie Ideen haben, wie man Oryx verbessern kann, Fragen oder Probleme auftreten, <strong>lassen Sie uns davon wissen!</strong></p>';
ORYX.I18N.Feedback.subjects=[{id:"question",name:"Frage",description:"Stellen Sie Ihre Frage!\nBitte schildern Sie die Umstände genau, damit wir Ihnen eine möglichst präzise Antwort geben können.",info:"",},{id:"problem",name:"Problem",description:"Bitte entschuldigen Sie die Unannehmlichkeiten. Beschreiben Sie das Problem bitte so genau wie möglich, damit wir es nachvollziehen und schnell beheben können.",info:"",},{id:"idea",name:"Idee",description:"Teilen Sie uns Ihre Ideen und Gedanken zu Oryx mit.",info:"",}];
