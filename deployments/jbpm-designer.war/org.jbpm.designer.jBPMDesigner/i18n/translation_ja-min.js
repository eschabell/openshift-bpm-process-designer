...
ORYX.I18N.BPMN2PNConverter={name:"Petri netへコンバート",desc:"BPMNダイアグラムをPetri netへコンバート",group:"エクスポート",error:"エラー",errors:{server:"BPNMダイアグラムがインポートできませんでした。",noRights:"該当モデルに読み込み許可はありますか？",notSaved:"モデルを保存しPetri netエクスポーターを使用するために再オープンする必要があります。"},progress:{status:"状態",importingModel:"BPMNモデルをインポート中",fetchingModel:"取得中",convertingModel:"コンバート中",renderingModel:"レンダリング中"}};
...
ORYX.I18N.JSONSupport={imp:{name:"JSONからインポート",desc:"JSONからモデルをインポート",group:"エクスポート",selectFile:"JSON (.json)ファイルを選択もしくはインポートするJSONを入力",file:"ファイル",btnImp:"インポート",btnClose:"閉じる",progress:"インポート中 ...",syntaxError:"構文エラー"},exp:{name:"JSONへエクスポート",desc:"JSONへ現在のモデルをエクスポート",group:"エクスポート"}};
ORYX.I18N.TBPMSupport={imp:{name:"PNG/JPEGからインポート",desc:"TPBMフォトからモデルをインポート",group:"エクスポート",selectFile:"イメージファイル(.png/.jpeg)を選択",file:"ファイル",btnImp:"インポート",btnClose:"閉じる",progress:"インポート中 ...",syntaxError:"構文エラー",impFailed:"ドキュメントのインポートに失敗しました",confirm:"ハイライトされたシェイプのインポートを確定"}};
